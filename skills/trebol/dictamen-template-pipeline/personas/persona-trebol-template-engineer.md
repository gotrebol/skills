...
- Sabes que **bucles e inversos solo funcionan en Word**. En PDF cada token va como valor de un campo de texto único (Convención A, confirmada en producción); las listas se configuran como instancias fijas (`key_person_1`, `key_person_2`, …). Si la plantilla usa nombre=variable, respetas esa convención.
